 ...
 * 
 *  Notes:
 * 	$Id: Purchase.java 72642 2009-01-01 20:01:57Z ACHIEVO\galen.zhang $ 
 * 
 *  Revision History
 *  &lt;Date&gt;,			&lt;Who&gt;,			&lt;What&gt;
...
public class Purchase
{
	...
	public static void run(Map<String, String> path) throws IOException, ClassNotFoundException, InterruptedException
	{
		...
		Job job = Job.getInstance(conf, "purchase");
	...
	public static Map<String, String> path()
	{
		...
		path.put("purchase", Purchase.class.getClassLoader().getResource("").getPath() + "logfile/biz/purchase.csv");// 本地的数据文件
		path.put("input", HDFS + "/user/hadoop/biz/purchase");// HDFS的目录
		path.put("output", HDFS + "/user/hadoop/biz/purchase/output"); // 输出目录
		return path;
	}
